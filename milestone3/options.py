...
optionList = dict([(optionParseAll, optionParseAllDef), (optionhelp, optionhelpDef), (optionPrintTokens, optionPrintTokensDef), (optionPrintProductionRules,optionPrintProductionRulesDef)])
